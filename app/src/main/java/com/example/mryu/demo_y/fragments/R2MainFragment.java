...
import com.example.mryu.demo_y.adapters.R2ViewPagerAdapter;
...
public class R2MainFragment extends BaseFragment {
    ...
    protected View onSubViewLoaded(LayoutInflater layoutInflater, ViewGroup container) {
        mRootView = layoutInflater.inflate(R.layout.fragment_r2_main, container, false);
        initView();
        return mRootView;
    }
    ...
    private void initView() {
        ...
        //创建内容适配器
        R2ViewPagerAdapter r1ViewPagerAdapter = new R2ViewPagerAdapter(getChildFragmentManager());
